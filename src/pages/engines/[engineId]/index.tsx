...
import {
    ...
    MaintenanceMore,
    MaintanceList,
} from '@/views/maintenances';
import { CollapseExpandCard } from '@/components/CollapseExpandCard/CollapseExpandCard';
...
const EnginePick: NextPageWithLayout = () => {
    ...
    return (
        <SwrLoadingHandle isLoading={isLoading} error={error}>
            ...
            <Dashboard.Title>Двигатель {engine.humanId}</Dashboard.Title>
